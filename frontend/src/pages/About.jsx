...
export default function About(){ return <div className='prose prose-invert'>
...
typedef struct Block {
    ...
    struct Block *next;
                    ...
                    <div>
                        <br /><br /><br /><br />
                <h2 className="mt-6 text-slate-400 text-lg max-w-xl">About Us</h2 ><p className="mt-6 text-slate-400 text-lg max-w-xl">About content...</p>
            </div>
      </span>
